(function ( $ ){
	...
	*/
	...
	var defaultKey		= '54L0YqabNJ9ZKVJqdz2oYVSCylTWhAttuFghsnCgRSKLaDs9', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1492660394], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Home 1', // Replaces Xively logo in the header
		dataDuration	= '86400', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
